// src/documentos/centro-guias/coordinacion/dto/create-documento-coordinacion.dto.ts
...
export class CreateDocumentoCoordinacionDto {
    @IsInt()
    ...
    @IsEnum(PagoType)
    pago: PagoType = PagoType.PREPAID;
